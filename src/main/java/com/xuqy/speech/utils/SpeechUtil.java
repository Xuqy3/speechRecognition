...
public class SpeechUtil {
    ...
    public static final String API_KEY = "ekp6mMZqhAnjAzsMwqU8Z3YX";

    public static final String SECRET_KEY = "X89gXrZb64XMZT6CceDuxayUcKmMv7UH";
...
//        SpeechSynthesizer("简单测试百度语音合成", "d:/SpeechSynthesizer.mp3");
        convertMP32Pcm("e:/goandback.mp3","e:/goandback.pcm");
        SpeechRecognition("e:/goandback.pcm","pcm");
    }
...
//        client.setSocketProxy("proxy_host", proxy_port);  // 设置socket代理
        ...
        log.info(" SpeechRecognition : " + res.get("result"));
